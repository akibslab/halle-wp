...
$halle_blog_date = get_theme_mod('halle_blog_date', true);
$halle_blog_comments = get_theme_mod('halle_blog_comments', true);
$halle_blog_author = get_theme_mod('halle_blog_author', true);
$halle_blog_cat = get_theme_mod('halle_blog_cat', false);

?>
<div class="ss-post__meta">
    <?php if (!empty($halle_blog_author)) : ?>
