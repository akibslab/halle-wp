        ...
        <div class="ss-post__container">
          ...
          ?>
            <div class="ss-page__header d-none">
              <h1 class="page__title"><?php esc_html_e('Search Results For:', 'halle'); ?> <?php print get_search_query(); ?></h1>
            </div>
            <?php
            ...
            <div class="ss__pagination">
              <?php halle_pagination('<i class="fal fa-arrow-left"></i>', '<i class="fal fa-arrow-right"></i>', '', ['class' => '']); ?>
            </div>
          <?php
          else :
