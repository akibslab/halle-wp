...
$halle_video_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ss__post format-video'); ?>>
        <?php if (has_post_thumbnail()) : ?>
            <div class="ss-feature__image">
                ...
                <?php if (!empty($halle_video_url)) : ?>
                    <div class="ss-post__video ss-video-btn__style">
                        <a href="<?php print esc_url($halle_video_url); ?>" class="popup-video"><i class="fa-solid fa-play"></i></a>
                    <?php endif; ?>
                    </div>
            </div>
        <?php endif; ?>
        ...
        <div class="ss__content">
            ...
            <div class="post-text">
                ...
                <?php
                wp_link_pages([
                    'before'      => '<div class="ss-page__links"> <span class="ss-page-links__title">' . esc_html__('Pages:', 'halle') . '</span>',
                    'after'       => '</div>',
                    'link_before' => '<span>',
                    'link_after'  => '</span>',
                    'pagelink'    => '<span class="screen-reader-text">' . esc_html__('Page', 'halle') . ' </span>%',
